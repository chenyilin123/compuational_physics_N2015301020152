...
plt.plot(x_e,y_e,color='blue',linewidth=1)
plt.plot(x_j,y_j,color='orange',linewidth=1)
plt.plot(x_s,y_s,color='red',linewidth=1)
plt.legend(('Earth','Jupiter','Sun'),'upper left')
plt.title('Figure 4 Three-body trajectory  Mass of Jupiter=1000$M_{j}$',fontsize=20)
plt.xlabel('x/AU')
plt.ylabel('y/AU')
#plt.xlim(-1.2,1.2)
#plt.ylim(-1.2,1.2)
plt.scatter(x_j[-1],y_j[-1],t[-1],label="Jupiter",color="orange")
plt.scatter(x_s[-1],y_s[-1],t[-1],label="Sun",color="red")
plt.scatter(x_e[-1],y_e[-1],t[-1],label="Earth",color="blue")
...
ax.set_ylabel('y/AU')
ax.set_zlabel('t/yr')
ax.scatter(x_j[-1],y_j[-1],t[-1],label="Jupiter",color="orange")
ax.scatter(x_s[-1],y_s[-1],t[-1],label="Sun",color="red")
ax.scatter(x_e[-1],y_e[-1],t[-1],label="Earth",color="black")
plt.legend(loc='upper right',fontsize=12)
plt.show()