...
Y1 = [800*x**2*math.exp(-100*x**2) for x in X]
Y1[0], Y1[-1] = 0., 0.
...
anim = animation.FuncAnimation(fig, animate, frames=200, init_func=initAnimation, interval=0.1, blit=True)
anim.save('ccc.gif', writer='imagemagick', fps=30, dpi=100)
pyplot.show()